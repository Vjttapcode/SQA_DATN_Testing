...
public class DataLoaderService {
    ...
    public List<TKBTemplateRow> loadTemplateData(String semester) {
        ...
        try {
            ...
            if (entities.isEmpty()) {
                log.warn("No template data found in database for {} {}", semesterName, academicYear);
    ...
    public List<TKBTemplateRow> loadTemplateData() {
        log.warn("loadTemplateData() called without semester parameter. Using default 'real.json'");
    ...
    public List<TKBTemplateRow> getTemplateByPeriods(int totalPeriods) {
        log.warn("getTemplateByPeriods() called without semester. Using default.");
