...
-- Mô tả: Chọn database schedule và import dữ liệu
-- =============================================

-- Chọn database schedule
USE schedule;
...
SELECT 'Faculties imported:' AS info, COUNT(*) AS total FROM faculties;
SELECT 'Rooms imported:' AS info, COUNT(*) AS total FROM rooms;
